...
VALUES      /*('TRAIT_CIVILIZATION_RWB_DIEVDIRBIAI',          'RWB_DIEVDIRBIAI_FAITH_BONUS_BASE'    ),
            ('TRAIT_CIVILIZATION_RWB_DIEVDIRBIAI',          'RWB_DIEVDIRBIAI_GOLD_BON   US_BASE'     ),*/
...
SELECT      BeliefType,'RWB_DIEVDIRBIAI_FAITH_PURCHASE_MALUS_RWB_LEADER_VYTAUTAS_MODIFIER'
FROM Beliefs WHERE BeliefClassType = 'BELIEF_CLASS_FOLLOWER' UNION
